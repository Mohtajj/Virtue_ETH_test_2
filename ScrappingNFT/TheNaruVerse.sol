...
contract TheNaruVerse is Ownable, ERC721URIStorage{
    ...
    uint CURRENT_TOKEN_PRICE = 0.05 ether;

    uint CURRENT_TOKEN_VALUE = 1 ether;
    ...
    function buyNFT(address payable _from, address _to, uint _tokenID) payable public {
        ...
        uint transactionFees = CURRENT_TOKEN_PRICE;
        ...
        // (bool _sent, ) = payable(address(this)).call{value: 0.05 ether}("");

        (bool sent, ) = _to.call{value: 0.05 ether}("");
